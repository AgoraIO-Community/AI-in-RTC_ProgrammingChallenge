<?php return array (
  ...
  array (
    ...
    'templates|dzwn_v1|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|dzwn_v1|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|dzwn_v1|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|dzwn_v1|wap' => 
    array (
    ...
    'templates|dzwn_v1|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|dzwn_v1|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|dzwn_v1|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|dzwn_v1|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|dzwn_v1|yp' => 
    array (
      'com_dzwn_v1' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|dzwn_v1|yp|com_dzwn_v1' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|dzwn_v1|comment' => 
    array (
